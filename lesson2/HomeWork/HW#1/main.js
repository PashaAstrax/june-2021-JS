...
for(simpson of simpsons){
	document.write(`<div>${simpson.name} ${simpson.surname} ${simpson.age} ${simpson.info} <img src="${simpson.photo}" alt="img"></div>`);
};
document.write(`</div>`);
...
for (simpson of simpsons){
	document.write(`<h2>${simpson.name} ${simpson.surname}.<br>Age is - ${simpson.age}</h2>
					<p>${simpson.info}</p>
					<img src="${simpson.photo}" alt="img">`)
};
document.write(`</div>`);
